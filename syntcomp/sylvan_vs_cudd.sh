...
#hyperfine -L benchmark $ADD/add8y.aag,$ADD/add12y.aag,$ADD/add16y.aag,$ADD/add20y.aag,$ADD/add24y.aag --warmup 1 './sylvan-solver {benchmark}'
#hyperfine -L benchmark $ADD/add8y.aag,$ADD/add12y.aag,$ADD/add16y.aag,$ADD/add20y.aag,$ADD/add24y.aag --warmup 1 './cudd-solver {benchmark}'
