...
# results_runtime = results / "sylvan-cudd" / "runtime"
...
def generate_quality_table():
    ...
    quality.to_csv(results / "sylvan_cudd_quality.csv", encoding='utf-8', index=False)
...
def generate_runtime_table():
    ...
    runtime.to_csv(results / "sylvan_cudd_runtime.csv", encoding='utf-8', index=False)
