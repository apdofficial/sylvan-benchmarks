...
if("${show_ref_output}" MATCHES "refs/remotes/v1.3.1")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.3.1")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 v1.3.1
  WORKING_DIRECTORY "/tmp/sylvan-benchmarks/build-cmake/_deps/lace-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/trolando/lace.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/tmp/sylvan-benchmarks/build-cmake/_deps/lace-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/tmp/sylvan-benchmarks/build-cmake/_deps/lace-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
